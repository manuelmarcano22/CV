...
\vspace{.3 cm}
  ...
  \begin{itemize}[label=$\blacktriangleright$]
  \item \emph{Operating Systems}: Linux, OS X, Windows
    \end{itemize}
...
\begin{itemize}[label=$\blacktriangleright$]
  ...
  \begin{itemize}[label=$\blacktriangleright$]
  \item \emph{Software}: Experienced working with Mathematica and \LaTeX. Some experience with Matlab and version control (git)  
    \end{itemize}
...
%\vspace{.3 cm}
%\begin{itemize}[label=$\blacktriangleright$]
%\item \emph{Astrobitos}: Native Language (\url{http://astrobitos.org/})
%\end{itemize}
